---
title: "Automate Spain Guest Registration (RD 933/2021) without Paperwork or Manual SES.HOSPEDAJES Submissions"
description: "A practical guide to automating guest check-in, reservation imports, and SES.HOSPEDAJES submissions for Spanish vacation rentals. What can be automated, and what still has to be validated by a person."
date: 2026-04-26
updated: 2026-05-01
...
[RegistroViajero](/en/) ticks all seven. Try it for 15 days without a credit card. The full flow can be set up in an afternoon.
...
- Still unclear on what the rule asks for? Start with [what RD 933/2021 requires](/en/blog/royal-decree-933-2021-guide/).
- Missing the last piece —the credentials— [we explain how to get them here](/en/blog/ses-hospedajes-credentials/).
- Handling families or groups? [The minors case](/en/blog/minors-guest-registration/) is worth reading before you configure the flow.
- Want to see the system in action? [Create a free 15-day account](https://app.registroviajero.com/register) and try a real submission with your next booking.
